...
import { CheckCircle, ChevronLeft, LayoutDashboard, LogOut, Menu, Settings, UtensilsCrossed, X } from 'lucide-react';
import BrandMark from './BrandMark';

const navItems = [
  { label: 'Display System', icon: LayoutDashboard, active: true },
