...
export default function ProfileManagementModal({ isOpen, onClose, user, onUpdateUser, apiService, roleLabel = 'Cashier' }) {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    formData.append('upload_preset', 'velluto_presets'); // Uses standard preset or direct fallback
