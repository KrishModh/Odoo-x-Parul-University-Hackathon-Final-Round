...
export default function SignupPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await signup({ ...form, role: 'cashier' });
  ...
  return (
    <AuthLayout mode="signup">
      <div className="auth-card__heading"><span className="eyebrow">GET STARTED</span><h2>Create your account</h2><p>We&apos;ll email a secure 6-digit code to verify your Velluto Cashier access.</p></div>
