...
from ..controllers.kitchen_controller import (
    get_kitchen_orders,
    get_kitchen_menu,
    get_kitchen_stats,
...
kitchen_bp.get('/menu')(roles_required('kitchen', 'admin')(get_kitchen_menu))
kitchen_bp.get('/stats')(roles_required('kitchen', 'admin')(get_kitchen_stats))
